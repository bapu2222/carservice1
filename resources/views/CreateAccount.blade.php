        ...
        <div class="flex-1 h-full max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-xl dark:bg-gray-800">
            <div class="flex flex-col overflow-y-auto md:flex-row">
                <div class="h-32 md:h-auto md:w-1/2">
                    <img aria-hidden="true" class="object-cover w-full h-full dark:hidden" src="images/Royal.jpg"
                         alt="Office"/>
                    <img aria-hidden="true" class="hidden object-cover w-full h-full dark:block" src="images/Royal.jpg"
                         alt="Office"/>
                </div>
                @if ($errors->any())
                ...
                <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                    <form class="w-full max-w-lg" action="{{route('do-register')}}"
                          method="POST">
                        @csrf
                        <div class="w-full">
                            ...
                            <label class="block text-sm">
                                ...
                                <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
