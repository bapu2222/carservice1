...
<head>
    ...
    <title>Regular Service - Car Service</title>
    <link
    ...
    <div class="flex flex-col flex-1 w-full">
        ...
        <main class="h-full pb-16 overflow-y-auto">
            <div class="container grid px-6 mx-auto">
                ...
                >
                    Manage Regular service
                </h2>
                <a
                        class="flex items-center justify-between p-4 mb-8 text-sm font-semibold text-purple-100 bg-purple-600 rounded-lg shadow-md focus:outline-none focus:shadow-outline-purple"
                        href="add_regular_service.html"
                >
                    <div class="flex items-center">

                        <span>Add Regular service</span>
                    </div>
                    <span>&plus;</span>
                </a>
                    ...
                    <div class="w-full overflow-x-auto">
                        <table class="w-full whitespace-no-wrap">
                            ...
                            <tr
                                ...
                                <th class="px-4 py-3">Solution ID</th>
                                <th class="px-4 py-3">Solution Name</th>
                                <th class="px-4 py-3">Duration[Month]</th>
                                <th class="px-4 py-3">Economy Price</th>
                                <th class="px-4 py-3">Classic Price</th>
                                <th class="px-4 py-3">Premium Price</th>
