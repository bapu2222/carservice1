...
<head>
    ...
    <title>AMC Membership - Car Service</title>
    <link
        ...
        <main class="h-full pb-16 overflow-y-auto">
            <div class="container px-6 mx-auto grid">
              ...
              focus:outline-none focus:shadow-outline-purple"
                        href="add_membership.html">
                    <div class="flex items-center">
                        <span>Add AMC Membership</span>
                    </div>
                    <span>&plus;</span>
                </a>
                <div class="w-full overflow-hidden rounded-lg shadow-xs">
                    <div class="w-full overflow-x-auto">
                      ...
                      bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                                ...
                                <th class="px-4 py-3">Allocate Solution</th>
                                <th class="px-4 py-3">Number of Solution</th>
