    ...
    <main class="h-full overflow-y-auto">
        <div class="container px-6 mx-auto grid">
            ...
            <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
                ...
                dark:bg-gray-800">
                    <div
                            class="p-3 mr-4 text-orange-500 bg-orange-100
                  rounded-full
                  dark:text-orange-100 dark:bg-orange-500">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20
                    20">
                            <path
                                    d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0
                      2 2 0
                      014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2
                      2 0
                      014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005
                      3.005 0
                ...
                dark:bg-gray-800">
                  ...
                  dark:text-green-100 dark:bg-green-500">
                    ...
                    20">
                            <path
                                    fill-rule="evenodd"
                                    d="M4 4a2 2 0 00-2 2v4a2 2 0 002 2V6h10a2 2 0
                      00-2-2H4zm2
                ...
                dark:bg-gray-800">
                  ...
                  dark:text-blue-100 dark:bg-blue-500">
                    ...
                    20">
                      ...
                      6.414
                      14H15a1 1 0 000-2H6.414l1-1H14a1 1 0
                      00.894-.553l3-6A1 1 0
                      0017 3H6.28l-.31-1.243A1 1 0 005 1H3zM16 16.5a1.5
                      1.5 0
                      11-3 0 1.5 1.5 0 013 0zM6.5 18a1.5 1.5 0 100-3 1.5
                      1.5 0
                      000 3z"></path>
                        </svg>
                    </div>
            ...
            <div class="w-full overflow-hidden rounded-lg shadow-xs">
                    ...
                    dark:bg-gray-800">
                        <tr class="text-gray-700 dark:text-gray-400">
                            <td class="px-4 py-3">
                                <div class="flex items-center text-sm">
                                    ...
                                    <div
                                            class="relative hidden w-8 h-8 mr-3
                            rounded-full
                            md:block">
                                        <img
                        ...
                        <span
                          ...
                          Approved
                            ...
                            py-2 text-sm font-medium leading-5
                            text-purple-600 rounded-lg dark:text-gray-400
                ...
                <div
                  ...
                  bg-gray-50
                  sm:grid-cols-9 dark:text-gray-400 dark:bg-gray-800">
                          ...
                          <button
                            ...
                            <svg
                              ...
                              <path
                                ...
                                7.293
                                6.707a1 1 0 011.414-1.414l4 4a1 1 0 010
                                1.414l-4
                                4a1 1 0 01-1.414 0z"
                                      clip-rule="evenodd"
                                      fill-rule="evenodd"></path>
